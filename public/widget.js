...
(function () {
  ...
  var css = "" +
    ...
    "#rdf-form{position:absolute;left:0;right:0;top:68px;bottom:0;background:#F4FAF8;z-index:5;display:flex;flex-direction:column;animation:rdfin .2s ease}" +
  ...
  function addRow(m) {
    ...
    rendered[m.ts] = 1;
    var anchor = $("rdf-typing") || $("rdf-warm");
    var node = buildRow(m);
  ...
  // --- cold-start capture: collect details while the free server wakes ---
